...
mse=(sum((true(index_fit)-fit0(index_fit)').^2))/(ngrid-2*q);
rmse=sqrt(mse);
Dmse=(sum((Dtrue-Dfit0').^2))/ngrid;
Drmse=sqrt(Dmse);
DDmse=(sum((DDtrue-DDfit0').^2))/ngrid;
DDrmse=sqrt(DDmse);
