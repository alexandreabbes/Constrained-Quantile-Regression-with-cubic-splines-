...
###############################
****Test_temp.py****					test on temperature identical to the test in the article (cubic splines), but implemented with python. "temp.xls"=data set of global temperatures
